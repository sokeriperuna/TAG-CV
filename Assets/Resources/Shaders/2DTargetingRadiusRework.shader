Shader "TAG/UI/2DTargetingRadiusRework"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                int circleHighlight = saturate(sign(sqrMagFromCenter-pow(0.49,2)));
                
                return texSample * toBeRendered*i.color * circleHighlight //circle highlight
                     + toBeRendered*i.color*(1-circleHighlight)* saturate(2.5*sqrMagFromCenter-0.1); //glow

                
                //return texSample * toBeRendered*i.color;
            }
            ENDCG
        }
    }
